...
extensions = {'ADA': '.abd', 'C++14': '.cpp', 'JAVA': '.java', 'PYTH': '.py', 'PYTH 3.6': '.py', 'C#': '.cs',
              ...
              'HASK': '.hs', 'SCALA': 'scala', 'D': '.d', 'PERL': '.pl', 'FORT': '.f', 'WSPC': '.ws', 'CAML': '.ml',
              'BF': '.bf', 'ASM': '.asm', 'CLPS': '.cli', 'PRLG': '.pro', 'ICON': '.icn', 'SCM qobi': '.scm',
              'ST': '.st', 'NICE': '.nice', 'LUA': '.lua', 'BASH': '.sh', 'NEM': '.n', 'LISP sbcl': '.lisp',
              'LISP clisp': '.lisp', 'SCM guile': '.scm', 'JS': '.js', 'PYPY3': '.py'}
headers = {
